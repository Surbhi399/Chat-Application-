...
public class Client  implements ActionListener
{
   ...
   static DataOutputStream dsend;
    Client()
    {
        ...
        ImageIcon m = new ImageIcon(ClassLoader.getSystemResource("icons/2.png"));
        ...
        JLabel name = new JLabel("Monster");
    ...
    {
        try {
            String output; // IT WILL TAKE TEXT WRITTEN IN MSG
            output = msg.getText();
...

    {
        ...
        try {
            ...
            DataInputStream dataread = new DataInputStream(s.getInputStream()); // taking input
            dsend = new DataOutputStream(s.getOutputStream()); //  recieving output
